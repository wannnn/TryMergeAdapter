...
import com.claire.trymergeadapter.wrapper.IWhatsNew.Companion.ONE
import com.claire.trymergeadapter.wrapper.IWhatsNew.Companion.THREE
import com.claire.trymergeadapter.wrapper.IWhatsNew.Companion.TWO
...
fun getMobileWhatsNew(): List<WhatsNewWrapper> {
    return listOf(
